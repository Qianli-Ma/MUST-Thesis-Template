       ...
       \toprule
        ...
        \midrule
            \citeauthor{Bawerk1922}; \citeauthor{Samuelson1937}; \citeauthor{Samuelson1937}
                & \icon{\XSolidBrush}                &  \icon{\Checkmark}               & \icon{\Checkmark}             &LQQL              & WP,RS
                & \citeyear{Samuelson1937}; \citeyear{Samuelson1937}; \citeyear{jevons1879}\\
                
            \citeauthor{Samuelson1937}
                & \icon{\XSolidBrush}             &  \icon{\Checkmark}            & \icon{\XSolidBrush}             & UJJ             & RSBB             
                & \citeyear{Samuelson1937}\\

            \citeauthor{Bawerk1922}
                & \icon{\XSolidBrush}                &  \icon{\Checkmark}            & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & APD             
                & \citeyear{Samuelson1937}\\
                
            \citeauthor{Samuelson1937}             
                & \icon{\XSolidBrush}                & \icon{\Checkmark}             &  \icon{\Checkmark}          & ULL               & RS,BB,QD             
                & \citeyear{Samuelson1937}\\
                
            \citeauthor{Choi2012}; \citeauthor{Goldfarb2009}; \citeauthor{Samuelson1937}
                &  SXXX             & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & RS
                &\citeyear{rae1905}; \citeyear{rae1905}; \citeyear{rae1905}\\
                
            \citeauthor{rae1905}             
                &  LXXX            & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & CS,RS             
                &\citeyear{rae1905}\\
                
            \citeauthor{rae1905}             
                & GXXX             &  \icon{\Checkmark}              &  \icon{\Checkmark}         &KJJ              & IS             
                &\citeyear{rae1905}\\
                
            \citeauthor{rae1905}              
                & GXXX             & \icon{\Checkmark}           & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & WP,RGMS,TPTF             
                &\citeyear{Brown2013}\\
                
            \citeauthor{rae1905}
                & NEVs SC             & \icon{\Checkmark}              & \icon{\XSolidBrush}             & \icon{\XSolidBrush}             & RS                        
                &\citeyear{Hossain2013}\\

\citeauthor{rae1905} & blockchain  & \icon{\XSolidBrush}   & \icon{\XSolidBrush}   & \icon{\XSolidBrush}   & XXX& \citeyear{rae1905}  \\ 
本研究      & NEVs SC     & \icon{\Checkmark}   & \icon{\Checkmark}       & XXX   & RSBB\\
